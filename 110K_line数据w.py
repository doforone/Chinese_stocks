...
for dd in ddd:
    ...
    if dd[0][:3]!="of.":
        ...
        print(dd[0])
        time.sleep(0.1)
        if os.path.exists(f'data/k_line_w/{dd[0]}_{a}.txt'):
            with open(f'data/k_line_w/{dd[0]}_{a}.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
    ...
    ##        frequency=a, adjustflag="3")
        ...
        with open(f'data/k_line_w/{dd[0]}_{a}.txt', 'w', encoding='utf-8', newline='\r\n') as f:
