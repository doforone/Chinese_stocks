...
print("========当日跌幅超过前N天排名（前12）========\r\n")
for rr in rrr[::-1][:12]:
    if rr[0][:6]=="sh.688":
        print(f"{rr[0]} {rr[1]}（{rr[2]}） 当日跌幅超过前：{rr[3]}天，数据截止：{rr[4]}，收盘价：{rr[5]}元  {'●' if rr[5]==1 else ''}  科创板")
    elif rr[0][:4]=="sz.3":
        print(f"{rr[0]} {rr[1]}（{rr[2]}） 当日跌幅超过前：{rr[3]}天，数据截止：{rr[4]}，收盘价：{rr[5]}元  {'●' if rr[5]==1 else ''}  创业板")
    else:
        print(f"{rr[0]} {rr[1]}（{rr[2]}） 当日跌幅超过前：{rr[3]}天，数据截止：{rr[4]}，收盘价：{rr[5]}元  {'●' if rr[5]==1 else ''}")
print("......")
