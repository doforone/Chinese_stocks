...
print(f"当日下跌超过9%，第二日累积涨跌：{rrr9['累积']:.2f}，次数：{rrr9['次数']}，平均：{rrr9['累积']/rrr9['次数']:.2f}%")
print(f"当日涨跌在-9%与-8%(含)之间，第二日累积涨跌：{rrr8['累积']:.2f}，次数：{rrr8['次数']}，平均：{rrr8['累积']/rrr8['次数']:.2f}%")
print(f"当日涨跌在-8%与-7%(含)之间，第二日累积涨跌：{rrr7['累积']:.2f}，次数：{rrr7['次数']}，平均：{rrr7['累积']/rrr7['次数']:.2f}%")
print(f"当日涨跌在-7%与-6%(含)之间，第二日累积涨跌：{rrr6['累积']:.2f}，次数：{rrr6['次数']}，平均：{rrr6['累积']/rrr6['次数']:.2f}%")
print(f"当日涨跌在-6%与-5%(含)之间，第二日累积涨跌：{rrr5['累积']:.2f}，次数：{rrr5['次数']}，平均：{rrr5['累积']/rrr5['次数']:.2f}%")
print(f"当日涨跌在-5%与-4%(含)之间，第二日累积涨跌：{rrr4['累积']:.2f}，次数：{rrr4['次数']}，平均：{rrr4['累积']/rrr4['次数']:.2f}%")
print(f"当日涨跌在-4%与-3%(含)之间，第二日累积涨跌：{rrr3['累积']:.2f}，次数：{rrr3['次数']}，平均：{rrr3['累积']/rrr3['次数']:.2f}%")
print(f"当日涨跌在-3%与-2%(含)之间，第二日累积涨跌：{rrr2['累积']:.2f}，次数：{rrr2['次数']}，平均：{rrr2['累积']/rrr2['次数']:.2f}%")
print(f"当日涨跌在-2%与-1%(含)之间，第二日累积涨跌：{rrr1['累积']:.2f}，次数：{rrr1['次数']}，平均：{rrr1['累积']/rrr1['次数']:.2f}%")
print(f"当日涨跌在-1%与0%(含)之间，第二日累积涨跌：{rrr0['累积']:.2f}，次数：{rrr0['次数']}，平均：{rrr0['累积']/rrr0['次数']:.2f}%")
